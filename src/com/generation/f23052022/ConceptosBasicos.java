...
public class ConceptosBasicos {
	...
	//main ctrl+space
		public static void main(String[] args) {
			...
			//el siguiente system es lo mismo que print, console.log, document.write, etc (syso ctrl+space)
			System.out.println(nombre);

			// 16 bit (solo permite un solo caracter, entre comillas simple)
			char letraA = 'a';
